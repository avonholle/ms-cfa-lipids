...
Measuring dyslipidemia as one joint distribution that incorporates the correlation between each of three commonly measured lipids is worthwhile either as an outcome or exposure in research. In a biologic sense, lipids do not function independently of one another and an analytic measure addressing their covariance is an asset. CFA leverages this characteristic of these measures to form a measure with different meaning from univariate indicators. Combining the observed correlations between the three common lipids alongside their common presentation in the literature and theoretical basis for dyslipidemia further justifies the use of CFA. 
