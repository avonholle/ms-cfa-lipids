...
Analyses demonstrate this construct is a alternate way to evaluate dyslipidemia using structural equation models. However, evaluation of this construct across socio-demographic groups such as race/ethnicity and gender provides evidence of a different multivariate structure requiring stratification.
